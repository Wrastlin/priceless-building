  ...
  if (rows.length === 0) {
    return (
      <div className="mt-12 border-y border-[var(--border)] py-16 text-center">
        <div className="font-mono text-[11px] uppercase tracking-[0.18em] text-[var(--brand-priceless)]">Empty cart</div>
  ...
  return (
    <div className="mt-12 grid gap-12 md:grid-cols-12">
      <div className="md:col-span-8">
        <div className="font-mono flex items-center justify-between border-b pb-3 text-[10px] uppercase tracking-[0.18em] text-[var(--muted-foreground)]">
          ...
          {rows.map((r) => (
            <li key={r.item.sku} className="grid grid-cols-[80px_1fr_auto_auto] items-center gap-5 py-5">
              ...
              <div className="text-right">
                ...
                <button onClick={() => remove(r.item.sku)} className="font-mono mt-1 text-[10px] uppercase tracking-[0.18em] text-[var(--muted-foreground)] underline decoration-2 underline-offset-2 hover:text-[var(--brand-priceless)]">remove</button>
              </div>
            </li>
          ))}
        </ul>
      ...
      <aside className="h-fit border-l border-[var(--border)] pl-8 md:col-span-4">
        <div className="font-mono text-[11px] uppercase tracking-[0.18em] text-[var(--brand-priceless)]">Order summary</div>

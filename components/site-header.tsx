  ...
  return (
    <>
      ...
      >
        <div className="mx-auto flex max-w-[1360px] items-center justify-between gap-3 px-4 py-3 md:gap-6 md:px-8 md:py-3.5">
          ...
          >
            ...
            <span className="hidden min-w-0 flex-col leading-none sm:flex">
              ...
              <span className="mt-1.5 text-[0.58rem] font-medium uppercase tracking-[0.22em] text-[var(--soft)]">
                Wausau, WI · Est. 1978
              </span>
            </span>
          </Link>
          ...
          <div className="flex shrink-0 items-center gap-1.5 md:gap-2">
            ...
            <a
              ...
              className="hidden h-9 items-center gap-2 border border-[var(--line)] px-3 text-[0.68rem] font-medium uppercase tracking-[0.12em] text-[var(--ink)] transition hover:border-[var(--ink)] xl:inline-flex"
            >
        ...
        >
          <ul className="mx-auto flex max-w-[1360px] items-center gap-5 overflow-x-auto px-4 py-2.5 text-[0.68rem] font-medium uppercase tracking-[0.14em] text-[var(--ink)] [-ms-overflow-style:none] [scrollbar-width:none] md:justify-center md:gap-6 md:px-8 md:py-3 [&::-webkit-scrollbar]:hidden">

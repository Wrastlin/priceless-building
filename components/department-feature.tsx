...
/**
 * Promotional department feature — a short story + real warehouse floor
 * photos. Placement scenes live in the faded category hero instead, so this
 * band stays documentary (no cluster of AI room stills).
 */

...
export function HeroSlideshow() {
  ...
  return (
    <section className="bg-white">
      <div className="px-0 pb-0 md:px-5 md:pb-5">
        <div className="relative h-[74svh] w-full overflow-hidden md:h-[82svh]">
          ...
          <div className="absolute inset-0 flex flex-col items-center justify-center px-6 text-center text-white">
            ...
            <h1
              className="font-display max-w-[18ch] text-[clamp(2.6rem,1rem+5.4vw,5.6rem)] leading-[1.02] text-white"
              style={{ textShadow: "0 2px 26px rgba(0,0,0,.45)" }}
            >
              Discount building materials in Wausau
            </h1>
            <Link
              href="/shop"
      ...
      <p className="mx-auto max-w-[52ch] px-6 pb-4 pt-8 text-center text-[1rem] font-light leading-[1.6] text-[var(--soft)] sm:px-8 sm:pb-6 sm:pt-12 sm:text-[1.1rem]">
        Doors, windows, cabinets, vanities, and lighting — surplus and overstock,
        tagged and ready to take home. Same building on Washington Street since 1978.
      </p>
